    ...
    <main className="h-body">
        {works.map((work) => (
          <p key={work.work_id} className='mt-[5%] ml-[10%]'>
            <Link href={`/${work.work_id}/text/${work.work[0].id}`} className="inline-flex items-center justify-center p-5 text-base font-medium text-gray-600 rounded-lg bg-gray-200 hover:text-gray-900 hover:bg-gray-300">
